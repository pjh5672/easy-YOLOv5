...
def build_parser(root_dir):
    ...
    parser.add_argument('--arch', type=str, default='yolov5n', 
    ...
    parser.add_argument('--nms-thres', type=float, default=0.6,
                        help='threshold to filter Box IoU of NMS process (default:0.6)')
